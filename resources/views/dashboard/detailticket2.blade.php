        ...
        <div class="bg-slate-900/50 border border-blue-900/50 rounded-2xl p-6 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <h1 class="text-white text-2xl font-bold">Détail du Ticket: Premium</h1>
                </div>
            ...
            <div class="grid grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <p class="text-white text-lg font-medium">Premium</p>
                    </div>

                    <div>
                        <label class="block text-slate-400 text-sm mb-4">Description</label>
                        <ul class="space-y-3 text-white">
                            <li class="flex gap-3"><i class="fas fa-check text-orange-500"></i> Accès rapide avec un bracelet</li>
                            <li class="flex gap-3"><i class="fas fa-check text-orange-500"></i> Accès de deux jours au festival</li>
                            <li class="flex gap-3"><i class="fas fa-check text-orange-500"></i> Proximité à la scène</li>
                            <li class="flex gap-3"><i class="fas fa-check text-orange-500"></i> Accès au village Eyra (Espace Restauration, Bars, Mode & Jeux)</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-white text-lg font-medium">50 000 FCFA</p>
                    </div>
                </div>
        ...
        <div class="bg-slate-900/80 border border-slate-800 rounded-xl p-8">
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="bg-slate-950/50 border border-slate-800 rounded-xl p-6">
                    ...
                    <div class="text-white text-3xl font-bold mb-1">4 500 000 F</div>
                    <div class="text-slate-500 text-xs">90 x 50 000 F</div>
                </div>
