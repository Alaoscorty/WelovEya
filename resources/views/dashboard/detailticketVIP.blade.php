...
@section('content')
    ...
    <div class="ml-64 p-8">
        ...
        <div class="bg-slate-900/50 border border-blue-900/50 rounded-2xl p-6 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <a href="{{ url()->previous() }}" class="w-10 h-10 flex items-center justify-center hover:bg-slate-800 rounded-lg transition">
                        <i class="fas fa-arrow-left text-white"></i>
                    </a>
                    <h1 class="text-white text-2xl font-bold">Détail du Ticket : VIP</h1>
                </div>
        ...
        <div class="bg-slate-900/80 border border-slate-800 rounded-xl p-8 mb-8">
            <h2 class="text-white text-xl font-semibold mb-8">Configuration et paramètres du ticket</h2>
            ...
            <div class="grid grid-cols-2 gap-12">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-white text-lg font-medium">VIP</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            @foreach([
                                'Accès de deux jours au festival',
                                'Proximité directe à la scène',
                                'Accès au village Eyra (Espace Restauration, Bars, Mode & Jeux)',
                                'Accès à une tente VIP',
                                'Espace Détente',
                                'Restauration et boisson offert (Stand dédié)',
                                'Accès rapide avec un bracelet'
                            ] as $item)
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-white text-lg font-medium">150 000 FCFA</p>
                    </div>
