        ...
        <div class="form-section">
            ...
            <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nom" name="nom" placeholder="Entrez le nom de l'article" value="{{ old('nom') }}" required>
                    @error('nom')
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="prix_vente" name="prix_vente" placeholder="0.00" step="0.01" min="0" value="{{ old('prix_vente') }}" required>
                    @error('prix_vente')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="categorie" name="categorie" required>
                        ...
                        <option value="vetement" {{ old('categorie') == 'vetement' ? 'selected' : '' }}>Vêtement</option>
                        <option value="electronique" {{ old('categorie') == 'electronique' ? 'selected' : '' }}>Électronique</option>
                        <option value="alimentaire" {{ old('categorie') == 'alimentaire' ? 'selected' : '' }}>Alimentaire</option>
                        <option value="maison" {{ old('categorie') == 'maison' ? 'selected' : '' }}>Maison & Jardin</option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" placeholder="Description détaillée de l'article" required>{{ old('description') }}</textarea>
                    @error('description')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
