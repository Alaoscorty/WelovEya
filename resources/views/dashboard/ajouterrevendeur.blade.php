...
@section('content')
        ...
        <main class="ml-2 w-full p-8">
            ...
            <form action="{{ route('resellers.store') }}" method="POST" id="revendeurForm" class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700 p-8">
                ...
                <div class="flex justify-end gap-4 pt-6 border-t border-gray-700">
                    ...
                    <button
                        type="submit"
                        class="px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold rounded-lg transition shadow-lg"
                    >
                        Créer le Revendeur
                    </button>
                </div>
    ...
    <script>
        ...
        document.getElementById('revendeurForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            console.log('Création du revendeur:', data);
            
            // Envoi via fetch (AJAX)
            fetch('{{ route("resellers.store") }}', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    alert('Erreur lors de la création du revendeur');
                }
            })
            .catch(error => {
        ...
        document.getElementById('telephone').addEventListener('input', function(e) {
            ...
            // Format automatique pour le Bénin (+229)
